...
Deno.serve(async (req) => {
  ...
  try {
    ...
    const systemPrompt = `Tum ek friendly Indian personal finance assistant ho. User ki language me jawab do (Hinglish/Hindi/English jo bhi user use kare).
...
- Agar koi question off-topic ho (finance se related nahi), politely redirect karo.`;
